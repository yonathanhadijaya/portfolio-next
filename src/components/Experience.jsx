    ...
    >
      ...
      >
        <h3 className="capitalize font-bold text-2xl ">
          {position} &nbsp;{" "}
          <a href="http://" target="_blank" className="text-primary capitalize">
            @{company}
          </a>
        </h3>
      ...
      <div ref={ref} className="w-[75%] mx-auto relative">
        ...
        <ul className="flex flex-col items-start justify-between ml-4">
          <Details
            ...
            companyLink="www.japfa.com"
            time="2023-2024"
            address="Sidoarjo, Jawa Timur"
            work="Bekerja dalam tim Digitalisasi dengan jobdes membuat front-end Web Server Daily Report."
          />
          <Details
